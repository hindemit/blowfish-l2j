package io.github.hindemit.crypt.utils;

/**
 * The {@code BlowfishConstants} class defines key constants used in the
 * Blowfish encryption algorithm.
 * <p>
 * This class contains the number of rounds, block size, S-box size, P-array size,
 * and the initial key arrays (P-array and S-boxes) as defined by the Blowfish specification.
 * These constants are used during key expansion and encryption/decryption operations.
 * </p>
 *
 * <p>All fields are static and final. This class is not meant to be instantiated.</p>
 *
 * <p>Example usage:</p>
 * <pre>
 * int rounds = BlowfishConstants.ROUNDS;
 * int firstP = BlowfishConstants.KP[0];
 * </pre>
 *
 * @see <a href="https://www.schneier.com/academic/blowfish/">Bruce Schneier, Blowfish Specification</a>
 * @see <a href="https://en.wikipedia.org/wiki/Blowfish_(cipher)">Blowfish Cipher – Wikipedia</a>
 * @see <a href="https://www.schneier.com/cryptography/blowfish/">Schneier on Security – Blowfish</a>
 *
 * @author Hindemit
 */
public class BlowfishConstants {
    ...
    /** Number of rounds in the Blowfish algorithm. */
    public static final int ROUNDS = 16;

    /** Block size in bytes. */
    public static final int BLOCK_SIZE = 8;

    /** Size of each S-box (number of entries). */
    public static final int S_BOX_SK = 256;

    /** Size of the P-array (ROUNDS + 2). */
    public static final int P_SZ = ROUNDS + 2;

    /** Initial P-array values as defined by Blowfish. */
    public static final int[] KP = {0x243F6A88, 0x85A308D3, 0x13198A2E,
    ...
    /** Initial values for S-box 0. */
    public static final int[] KS0 = {0xD1310BA6, 0x98DFB5AC, 0x2FFD72DB,
    ...
    /** Initial values for S-box 1. */
    public static final int[] KS1 = {0x4B7A70E9, 0xB5B32944, 0xDB75092E,
    ...
    /** Initial values for S-box 2. */
    public static final int[] KS2 = {0xE93D5A68, 0x948140F7, 0xF64C261C,
    ...
    /** Initial values for S-box 3. */
    public static final int[] KS3 = {0x3A39CE37, 0xD3FAF5CF, 0xABC27737,
